...
| ---------------------------- | ------------------------------------------ | ----------------------------------------------------- |
| Official Codex CLI `0.149.1` | `ff29a44391deccde0aba0f8390337d7f3c319ea4` | One canonical `functions` namespace                   |
...
The package targets the official `0.149.1` contract, whose default-tool layout remains unchanged
...
| Version compatibility      | The package follows official Codex `0.149.1` and intentionally does not provide a legacy direct-declaration mode for `0.146.0` or older clients.                                                                                                                                                                                                                                                           |
