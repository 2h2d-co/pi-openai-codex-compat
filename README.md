...
| Searchable `tool_search` catalog                                        | This package declares every tool at the top level and does not implement Codex's searchable deferred-tool catalog and ranking runtime.                        |
