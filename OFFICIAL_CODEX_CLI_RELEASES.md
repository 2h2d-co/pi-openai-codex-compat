...
| Latest prerelease seen  | `0.150.0-alpha.13`; noted only, not used as the baseline                                       |
...
- GitHub's latest stable release and npm's `latest` dist-tag both resolved to
  ...
  baseline; the newest prerelease observed during the subsequent command-tool
  alignment review was `0.150.0-alpha.13`.
