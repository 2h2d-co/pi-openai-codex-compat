...
- `apply_patch` must remain workspace-scoped, reject `.git` paths and symlink escapes, validate all hunks before writes, and participate in Pi's file mutation queue.
