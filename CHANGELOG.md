...
- Add default-off `apply_patch` diagnostics capture with full pre-execution
  source and destination snapshots, patch instructions, outcomes, and
  Pi/provider trace identifiers linked from tool-result details.
